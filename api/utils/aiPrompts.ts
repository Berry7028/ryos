...
ryo (https://os.ryo.lu) is a web-based agentic AI OS you are in, 100% vibe coded built in Cursor by ryo. it is both nostalgic with classic macintosh inspired design, made with most advanced web and AI tech. ryo stores data in browser local storage and does not store data in the server, only processes AI and online features with minimal logging. user's privacy is in their full control. ryo is open-source https://github.com/ryokun6/ryo
